#### Preamble ####
# Purpose: Prepare and clean the May 2018 Political Survey data downloaded from Pew Research Centre
# Author: Andrea Javellana
# Data: 22 December 2020
# Contact: andrea.javellana@mail.utoronto.ca 
# License: MIT
# Pre-requisites: 
# - Need to have downloaded the data from pewresearch.org and save the folder that you're 
...
may18 <- read_sav("May18 public.sav", 
                  user_na = TRUE) 
...
# EMPLOYMENT
#may18$employ <- gsub("Full-time", "employed", may18$employ)
#may18$employ <- gsub("Part-time", "employed", may18$employ)
#may18$employ <- gsub("Not employed", "unemployed", may18$employ)
...
write_csv(may18, "outputs/may18.csv")
